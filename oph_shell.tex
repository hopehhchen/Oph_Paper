...
approximate range of 0.1$<$$A_K$$<$1 in extinction which is most relevant to our study of the shell structure. However, the agreement is not perfect, particularly at high extinction $A_K$$\gtrsim$1. We defer a full, detailed comparison of multiple methods by which to derive dust and gas column densities throughout the entire Ophiuchus molecular cloud to a future work (Chen et al., in preparation).

\begin{figure}[ht]
\centering
\includegraphics[scale=0.475]{fig/scatter_herschel_nicest.png}
\caption{\label{fig:herschel_nicest} Log-log scatter plot of NICEST extinction ($A_K$) versus our Herschel-based $\tau_{350\mu m}$ over the entire Ophiuchus region, after regridding to the NICEST pixelization. Across a wide range of $A_K$, approximately 0.1$<$$A_K$$<$1, there is a very strong and nearly linear correlation. However, the 
agreement is not perfect, particularly at high extinction, $A_K$$\gtrsim$1. More specifically, the best-fit log-log slope over the range in $\tau_{350\mu m}$ indicated by the vertical green lines is 1.10, suggesting that the relationship between NICEST $A_K$ and Herschel optical depth is close to, but not exactly linear.}
\end{figure}
...
%%%%estimate of the uncertainty introduced by the "non-converage" of the Herschel maps%%%

%%%(246.53961839324353, -23.492406231434657)
%%%0.43565150720365864
%%%0.8710479702683926
